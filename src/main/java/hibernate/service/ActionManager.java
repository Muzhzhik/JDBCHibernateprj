...
import hibernate.console.ConsoleController;
import hibernate.entity.Order;
import hibernate.repository.OrderRepository;
import hibernate.utils.Action;
...
public class ActionManager {
        ...
        do {
            ...
            try {
                ...
                if (order == null) {
                    ...
                    if (new OrderRepository().update(order)) {
    ...
    private void createOrder() {
        ...
        if (new OrderRepository().create(new Order(clientName, phone, order))) {
